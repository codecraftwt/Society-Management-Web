...
export default function CommitteeNotices() {
  ...
  useEffect(() => { if (!initialLoad) loadNotices(1, debSearch); }, [debSearch]);

  useEffect(() => {
    const onNoticeCreated = (notice) => {
      setNotices((prev) => {
        // Already in list (added by reload after submit, or duplicate event) — skip
        if (prev.find((n) => n.id === notice.id)) return prev;
        // Notice from another user — prepend it and bump counts
        setTotalAll((c) => c + 1);
        setTotalItems((c) => c + 1);
        return [notice, ...prev];
      });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setFile(null);
      setShowForm(false);
      // Always reload after submit so the new notice appears immediately
    ...
    <div className="space-y-5 animate-fadeIn">
      ...
      <div style={{
        ...
        <div style={{
          ...
          gap: 10, padding: "11px 16px", borderBottom: "1px solid var(--divider)",
          background: "var(--card-inner-bg)", flexWrap: "wrap",
        }}>
          <div style={{ display: "flex", alignItems: "center", gap: 7 }}>
            ...
            <span style={{ fontSize: 12, color: "var(--text-secondary)", fontWeight: 500 }}>
              {initialLoad
                ? "Loading…"
                : `${totalItems} notice${totalItems !== 1 ? "s" : ""}${search ? ` matching "${search}"` : ""}`}
            </span>
          </div>
          <div style={{ position: "relative", width: "100%", maxWidth: 240 }}>
            <MdSearch size={13} style={{
                  ...
                  {notices.map((n, idx) => {
                    ...
                    return (
                      <tr
                        ...
                        style={{
                          borderBottom: "1px solid var(--divider)", transition: "background 0.15s",
                        ...
                        <td style={{ padding: "12px 16px", verticalAlign: "middle", position: "relative" }}>
                          ...
                          <div style={{ display: "flex", alignItems: "center", gap: 10, paddingLeft: 4 }}>
                            ...
                            <div style={{ minWidth: 0 }}>
                              ...
                              <p style={{
                                fontSize: 11, margin: "2px 0 0", color: "var(--text-secondary)",
              ...
              {notices.map((n, idx) => {
                ...
                return (
                  <div
                    ...
                    className="animate-fadeIn"
                    style={{
                      position: "relative", borderBottom: "1px solid var(--divider)",
                  ...
                  >
                    ...
                    <div style={{ display: "flex", alignItems: "flex-start", gap: 10 }}>
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        <p style={{
                          fontSize: 12, margin: "3px 0 0", color: "var(--text-secondary)",
      ...
      {filePreview && createPortal(
        <div
          style={{
            position: "fixed", inset: 0, zIndex: 9999, background: "rgba(0,0,0,0.88)", backdropFilter: "blur(8px)",
              ...
              <>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 10, marginBottom: 10 }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 10, overflow: "hidden", minWidth: 0 }}>
                    ...
                    <span style={{
                      color: "var(--text-primary)", fontSize: 13, fontWeight: 650,
                      overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap",
                    }}>
                      {filePreview.name}
                    </span>
                  ...
                  <div style={{ display: "flex", gap: 8, flexShrink: 0 }}>
                    <a
                      ...
                      style={{
                        padding: "7px 14px", borderRadius: 999, fontSize: 12, fontWeight: 650,
                ...
                {filePreview.previewUrl ? (
                  ...
                  <div style={{
                    ...
                    <a
                      href={filePreview.fullUrl} target="_blank" rel="noopener noreferrer"
                      style={{
                        padding: "8px 20px", borderRadius: 999, background: "var(--accent)",
