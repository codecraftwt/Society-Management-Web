  ...
  return (
    <div className="sa-page" style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
      ...
      <div className="soc-form-card">
        ...
        <div className="overflow-x-auto"><form onSubmit={handleSubmit} className="soc-form-row">
          <div className="sa-input-group">
            <label className="sa-label">{t("saSocietyName")}</label>
            <div className="sa-input">
              <FaBuilding size={15} className="sa-input-icon" />
              <input
                className="soc-input"
                type="text"
          ...
          <div className="sa-input-group">
            ...
            <div className="sa-input">
              <MdLocationOn size={15} className="sa-input-icon" />
              <input
                className="soc-input"
                type="text"
          ...
          <button
            ...
            className="sa-btn sa-btn-primary soc-submit-btn"
            style={{ height: 42 }}
          >
                  ...
                  <div key={society.id} className="soc-mobile-card">
                    <div className="soc-mobile-head">
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        <p className="soc-mobile-name">{society.name}</p>
                      ...
                      <span className="soc-mobile-id">#{idx + 1}</span>
                    </div>
                    <Link
