      ...
      <div style={{
        ...
        {!initialLoad && totalAll > 0 && notices.length === 0 && !fetching && (
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center",
            ...
            <button onClick={() => setSearch("")}
              style={{ fontSize: 12, color: "#94B5F5", background: "none", border: "none",
                        ...
                        <td style={{ padding: "12px 16px", verticalAlign: "middle", textAlign: "right" }}>
                          {n.file_url ? (
                            <button
                              ...
                              onMouseEnter={(e) => { e.currentTarget.style.background = "rgba(91,141,239,0.16)"; e.currentTarget.style.borderColor = "rgba(91,141,239,0.35)"; }}
                              onMouseLeave={(e) => { e.currentTarget.style.background = "rgba(91,141,239,0.08)"; e.currentTarget.style.borderColor = "rgba(91,141,239,0.20)"; }}
                            >
                          ...
                          <div style={{ display: "flex", justifyContent: "flex-end", gap: 8 }}>
                            <button
                              ...
                              style={{
                                ...
                                background: "rgba(107,70,193,0.1)", color: "#9F87D7", border: "1px solid rgba(107,70,193,0.2)"
                              }}
                            >
                              Edit
                            </button>
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        <div style={{ display: "flex", alignItems: "center", gap: 8, marginTop: 6, flexWrap: "wrap" }}>
                          ...
                          <div style={{ display: "flex", gap: 8 }}>
                            <button
                              onClick={() => handleEdit(n)}
                              style={{ fontSize: 11, fontWeight: 600, color: "#9F87D7" }}
                            >
                              Edit
                            </button>
                            <button
